...
time python /Volumes/MAC_Data/data/labs/zhang_lab/sequence_prediction/nfyb_fos/rnn_for_seq/bin/simulation/fasta_generator_3motif_coverall.py -l 100 -n 10000 -u ACGT -a 03322 -p 0.75 -b 10132 -q 0.85 -c 33301 -t 0.5 -s 2017 -r upstream -v downstream -o motif1_up_motif2_down_motif3.fa
...
head -6000 motif1_up_motif2_down_motif3.txt > train_pos.txt
head -6000 motif1_up_motif2_down_motif3.shuffle.txt > train_neg.txt
tail -n+6001 motif1_up_motif2_down_motif3.txt > test_pos.txt
