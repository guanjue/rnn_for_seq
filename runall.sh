...
time python /Volumes/MAC_Data/data/labs/zhang_lab/sequence_prediction/nfyb_fos/rnn_for_seq/bin/simulation/fasta_generator.py -l 100 -n 10000 -u ACGT -a 03322 -b 30331 -s 2017 -r upstream -o motif1_up_motif2.fa
### dimer shuffle sequence
time fasta-dinucleotide-shuffle -f motif1_up_motif2.fa -s 2017 -c 2 > motif1_up_motif2.shuffle.fa
### 

time python /Volumes/MAC_Data/data/labs/zhang_lab/sequence_prediction/nfyb_fos/rnn_for_seq/bin/rnn_analysis_simulateseq.py