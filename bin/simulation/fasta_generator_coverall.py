...
### seq unit
def fasta_generator(seq_len, seq_num, nuc0, motif1_seq0, motif1_seq0_p, motif2_seq0, motif2_seq0_p, seed, relative_pos, outputname):
	np.random.seed(seed)
	### extract seq unit
	nuc = []
	for s in nuc0:
...
def main(argv):
	try:
		opts, args = getopt.getopt(argv,"hl:n:u:a:p:b:q:s:r:o:")
	...
	fasta_generator(seq_len, seq_num, nuc0, motif1_seq0, motif1_seq0_p, motif2_seq0, motif2_seq0_p, seed, relative_pos, outputname)
