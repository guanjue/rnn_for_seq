...
############################################################################
#time python txt2npz.py -f motif1_up_motif2.fa -o motif1_up_motif2.txt -u ACGT
...
def main(argv):
	try:
		...
		print 'python txt2npz.py -f inputname -o outputname -u seq_unit<ACGT>'
		sys.exit(2)
	...
	txt2npz(input_fasta, outputname, nuc0)
